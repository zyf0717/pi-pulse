    ...
    ui.navset_tab(
        ...
        ui.nav_panel(
            ...
            ui.layout_column_wrap(
                ui.value_box(
                    "Temperature",
                    ui.output_text("sen66_temp_val"),
                    showcase=ui.tags.i(class_="bi bi-thermometer-half"),
                ),
                ui.value_box(
                    "Humidity",
                    ui.output_text("sen66_hum_val"),
                    showcase=ui.tags.i(class_="bi bi-droplet-half"),
                ),
                ui.value_box(
                    "CO₂",
                    ui.output_text("sen66_co2_val"),
                    showcase=ui.tags.i(class_="bi bi-cloud"),
                ),
                ui.value_box(
                    "VOC Index",
                    ui.output_text("sen66_voc_val"),
                    showcase=ui.tags.i(class_="bi bi-wind"),
                ),
                ui.value_box(
                    "NOx Index",
                    ui.output_text("sen66_nox_val"),
                    showcase=ui.tags.i(class_="bi bi-broadcast"),
                ),
                fill=False,
            ),
            ui.hr(),
